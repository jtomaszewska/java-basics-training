...
public class Main {
  public static void main(String[] args) {
    ...
    // Sposoby tworzenia
    XList<Integer> list1 = new XList<Integer>(1, 3, 9, 11);
    XList<Integer> list2 = XList.<Integer>of(5, 6, 9);
    XList<Integer> list3 = new XList(ints);
    XList<Integer> list4 = XList.<Integer>of(ints);
    XList<Integer> list5 = new XList(set);
    XList<Integer> list6 = XList.<Integer>of(set);
